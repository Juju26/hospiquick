...
class AdminCheck extends Component {
    ...
    componentDidMount() {
        ...
        let url = "http://localhost:8085/appointments/" + user;
        console.log(url);
        fetch(url)
            .then((res) => res.json())
            .then((json) => {
                                                ...
                                                apps.map((app) => (
                                                    <tr key={app.appId}>
                                                        ...
                                                        <td id="table-icons">
                                                            ...
                                                            <a href="#" onClick={(e) => {e.preventDefault();this.deleteApp(app.appId);window.location.href='/appointment';}}  className="delete" title="Delete" data-toggle="tooltip"><i className="material-icons">&#xE872;</i></a>
                                                        </td>
                                                    </tr>
