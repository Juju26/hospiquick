...
class AdminVaccination extends Component {
    ...
    componentDidMount() {
        fetch("http://localhost:8086/vaccination")
            .then((res) => res.json())
            .then((json) => {
                this.setState({
                    apps: json,
...

                                            {
                                                apps.map((app) => (
                                                    <tr key={app.appId}>
                                                        ...
                                                        localStorage.setItem("editDept",app.vaccine);window.location.href='/appointment-edit';}} class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
